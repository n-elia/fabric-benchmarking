...
class CreateAssetWorkload extends WorkloadModuleBase {
    ...
    constructor() {
        ...
        this.policyId = "";
        this.chunkLen = 50;
        this.enableUpdateChunkExpiryDate = false;
    ...
    async submitTransaction() {
        let args = {
            ...
            contractFunction: "AddChunkWithPolicy",
            contractArguments: [
                generateChunkIds(1)[0],
                Buffer.from(JSON.stringify(this.assetGen.getAsset())).toString("base64"),
                this.policyId
            ],
